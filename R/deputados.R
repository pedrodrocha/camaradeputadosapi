...
#' @description
#'
#' Get metadata information of data related to deputados. Two types of metadata is available: a) 'siglaUF', with a list of Brazilian states; b) 'siglaSituacao', with a list of status for representatives.
#'
